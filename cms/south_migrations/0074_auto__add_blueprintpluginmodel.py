...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlueprintPluginModel'
        db.create_table(u'cms_blueprintpluginmodel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cms', ['BlueprintPluginModel'])


    def backwards(self, orm):
        # Deleting model 'BlueprintPluginModel'
        db.delete_table(u'cms_blueprintpluginmodel')
    ...
    models = {
        ...
        'cms.blueprintpluginmodel': {
            'Meta': {'object_name': 'BlueprintPluginModel', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
