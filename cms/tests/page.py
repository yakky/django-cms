...
class MigrationTestCase(CMSTestCase):
    ...
    def test_content_type(self):
        ...
        self.assertFalse(ContentType.objects.filter(model='page', name='',
                                                    app_label='cms').exists())
        self.assertTrue(ContentType.objects.filter(model='page', name='page',
                                                   app_label='cms').exists())
