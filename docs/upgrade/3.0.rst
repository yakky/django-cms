...
CMS_PAGE_TEMPLATE context variable
==================================

A new ``CMS_PAGE_TEMPLATE`` is available: it's available in pages and apphook-ed
applications, and it contains the path to the current page template.
See :ref:`CMS_PAGE_TEMPLATE reference <page_template>` for details.
