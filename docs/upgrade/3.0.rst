...
PAGE_TEMPLATE context variable
==============================

A new ``PAGE_TEMPLATE`` is available: it's available in pages and apphook-ed
applications, and it contains the path to the current page template.
See :ref:`PAGE_TEMPLATE reference <page_template>` for details.
